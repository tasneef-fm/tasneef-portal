...
function financeCalcExpenseTotal(){ const sub=num($('financeExpenseSubtotal')?.value), vat=num($('financeExpenseVat')?.value); if($('financeExpenseTotal')) $('financeExpenseTotal').value=(sub+vat).toFixed(2); }
