/* Tasneef v10153 - Monthly Times Cache System
...
(function(){
  'use strict';
  if(window.__tasneefMonthlyCacheV10153) return;
  window.__tasneefMonthlyCacheV10153=true;
  ...
  window.TasneefMonthlyV10153={reload:load,rebuild,edit:editManual,remove:removeManual,csv,print:printReport};
