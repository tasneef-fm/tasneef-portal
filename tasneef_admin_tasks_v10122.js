/* Tasneef v10122 - Administrative Tasks Supabase Online Only Robust Save Fix
   Scope: new section only. Does not touch finance, inventory, orders, tickets, contracts, attendance, monthly, or permissions.
*/
(function(){
  'use strict';
  if(window.__tasneefAdminTasksV10122) return;
  window.__tasneefAdminTasksV10122 = true;

  const VERSION='v10122-admin-tasks-online-robust';
