...
(function(){
  ...
  const BUILD='V10801-WHATSAPP-PRICE-HOTFIX';
  const PAGE_SIZE=50;
  ...
  function adminMarkup(){return `
    ...
    <div class="ov8-layout"><div class="card ov8-form" id="ov8FormCard"><h2 id="ov8FormTitle">إضافة أوردر</h2><input type="hidden" id="ov8EditId"><div class="ov8-grid">
      ...
      <div data-finance data-supervisor-lock><label>السعر شامل الضريبة</label><input id="ov8Total" type="number" step="0.01" readonly></div><div data-finance data-supervisor-lock><label>التكلفة</label><input id="ov8Cost" type="number" step="0.01"></div>
