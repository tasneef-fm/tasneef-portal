...
(function(){
  ...
  const OrdersUI={
    ...
    edit,view,receipts,archive,restore,closeReceiptPreview,archiveCurrent:()=>state.editingId?archive(state.editingId):notify('اختر أوردرًا أولًا.','err'),openAttachment,deleteAttachment,
